...
public class MathUtility {
    ...
    // 5 Create a method that can return the multiplication of two integers
    ...
    // 8 Create a method that can check if an integer is odd number
    public static boolean isOdd(int num){
        return (num%2!=0)? true: false;
    }

    // 9 Create a method that can check if an integer is even number
    ...
    // 14 Create a method that can return the square of an integer. 	Ex: square(2) ==> 4
