...
public class CapitoleOneObjects {
    ...
    public static void main(String[] args) {
      ...
      employee3.setInfo("David", 'M', 38, 2295, "QA", 45000, false);
      employee4.setInfo("Lina", 'F', 45, 2227, "BA", 80000, true);
      employee5.setInfo("Kevin", 'M', 48, 2298, "Senior QA", 110000, true);
