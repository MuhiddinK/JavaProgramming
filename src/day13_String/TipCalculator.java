...
public class TipCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("Split or No splitn(Yes or No)?");
        ...
        double tipRate = (service.equals("excellent"))? 0.25 :(service.equals("great"))? 0.2 :(service.equals("good"))?
                0.15 :(service.equals("fair"))? 0.1 : 0.05;

        double totalTip = amount * tipRate;

        System.out.println("Enter the number of people: " + numOfPeople);
