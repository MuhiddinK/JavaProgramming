...
public class SalaryCalculator {
    ...
    public static void main(String[] args) {
        ...
        int hourlyRate = 50,
            weeklyHours = 45;// araya virgul koyarak bir variable cok data icin kullanilabilir
        double stateTaxRate = 0,
                federalTaxRate = 26.2;

        //---------------------------------------------------------------------------

        int salaryBeforeTax = hourlyRate * weeklyHours * 52;// weekly salary * 52 = total salary before tax(Gross Pay)
